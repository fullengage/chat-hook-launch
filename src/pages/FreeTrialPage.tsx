...
const FreeTrialPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary/30 scroll-smooth">
      {/* Header / Logo */}
      <header className="py-6 border-b border-border/10 bg-background/50 backdrop-blur-md sticky top-0 z-50">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-6 md:gap-0">
          <div className="flex items-center gap-3">
             <img src="/icons.png" alt="Logo" className="w-20 h-20 md:w-24 md:h-24 object-contain" />
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col lg:flex-row items-center gap-20">
              ...
              <div className="lg:w-3/5 text-center lg:text-left space-y-8">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/20 rounded-full text-primary font-bold text-sm tracking-wide animate-pulse">
                   <Zap className="w-4 h-4" />
                   OFERTA LIMITADA: IMPLANTAÇÃO EM 48H
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4">
                   ...
                   <p className="text-sm text-muted-foreground font-medium">
                      Junte-se a <strong>500+ empresas</strong> que já escalaram.
                   </p>
                </div>
                ...
                <div className="grid sm:grid-cols-2 gap-6 py-4">
                 ...
                 <div className="flex flex-wrap justify-center lg:justify-start gap-4 pt-4">
                    ...
                    <div className="flex items-center gap-2 bg-primary/5 px-4 py-2 rounded-xl border border-primary/10">
                       ...
                       <span className="font-bold text-[11px] uppercase tracking-wider">Setar em 48h</span>
                    </div>
                    <div className="flex items-center gap-2 bg-primary/5 px-4 py-2 rounded-xl border border-primary/10">
                        <ShieldCheck className="w-4 h-4 text-primary" />
