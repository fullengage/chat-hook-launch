        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 max-w-7xl mx-auto">
           <div className="lg:w-1/2">
             <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-foreground leading-tight">
               Você não recebe só acesso ao sistema. <span className="text-primary">Nós ajudamos a estruturar sua operação.</span>
             </h2>
             ...
             <div className="grid gap-6">
                {steps.map((step, index) => (
                  <div key={index} className="flex gap-4 items-center p-4 rounded-xl border border-border hover:border-primary/30 transition-colors group">
                     {/* No icon rendering to keep it simple as I don't have all icons imported here, 
                         wait, I have most. Let me fix the imports. */}
                     <span className="text-primary font-bold text-2xl opacity-30 group-hover:opacity-100 transition-opacity">0{index + 1}</span>
                     <div>
           ...
           <div className="lg:w-1/2 relative">
              ...
              <div className="p-8 rounded-2xl bg-primary text-primary-foreground text-center shadow-2xl relative overflow-hidden">
